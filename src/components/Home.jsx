...
const Home = () => {
  return (
    <div class="flex-col mt-20  md:mt-0 md:flex-row justify-around md:min-h-screen items-center  flex md:px-24 file:  ">
      <div class=" text-center w-96 py-44 md:py-0">
        <h1 className="md:text-7xl text-6xl font-semibold my-4">Edu Falcon</h1>
